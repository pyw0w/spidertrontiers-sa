...
local spidertron_mk2_animations =
	require("__spidertrontiers-sa__.spidertron_animations.spidertron_mk2-animations")
local ground_triggers = require("__spidertrontiers-sa__.prototypes.ground_triggers")
local simulation = require("__spidertrontiers-sa__.prototypes.spidertron_mk2.simulation")
...
local spidertron_mk2 = {
	...
	icon = "__spidertrontiers-sa__/graphics/icons/spidertron_mk2.png",
	...
	minimap_representation = {
		filename = "__spidertrontiers-sa__/graphics/entity/spidertron_mk2/spidertron-map.png",
		flags = { "icon" },
		size = { 128, 128 },
		scale = 0.5,
	},
...
local spidertron_mk2_remnants = {
	...
	animation = make_rotated_animation_variations_from_sheet(1, {
		layers = {
			{
				filename = "__spidertrontiers-sa__/graphics/entity/spidertron_mk2/remnants/spidertron-remnants.png",
				line_length = 1,
				width = 224,
				height = 224,
				frame_count = 1,
				...
				r_version = {
					filename = "__spidertrontiers-sa__/graphics/entity/spidertron_mk2/remnants/hr-spidertron-remnants.png",
					line_length = 1,
					width = 448,
					height = 448,
					frame_count = 1,
			...
			{
				priority = "low",
				filename = "__spidertrontiers-sa__/graphics/entity/spidertron_mk2/remnants/mask/spidertron-remnants-mask.png",
				width = 184,
				height = 176,
				frame_count = 1,
				...
				hr_version = {
					priority = "low",
					filename = "__spidertrontiers-sa__/graphics/entity/spidertron_mk2/remnants/mask/hr-spidertron-remnants-mask.png",
					width = 366,
					height = 350,
					frame_count = 1,
					--tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 },
