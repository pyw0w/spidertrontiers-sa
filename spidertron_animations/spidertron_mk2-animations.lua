...
local leg_lower_part_graphics_definitions = {
	...
	top_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-lower-end-A.png",
		width = 20,
		height = 50,
		variation_count = 8,
		shift = util.by_pixel(0, 20),
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/hr-spidertron-legs-lower-end-A.png",
			width = 40,
			height = 98,
			variation_count = 8,
			scale = 0.5,
	...
	middle = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-lower-stretchable.png",
		width = 26,
		height = 192,
		variation_count = 8,
		scale = 0.5,
		...
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/hr-spidertron-legs-lower-stretchable.png",
			width = 50,
			height = 384,
			variation_count = 8,
			scale = 0.25,
	...
	bottom_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-lower-end-B.png",
		width = 18,
		height = 46,
		variation_count = 8,
		shift = util.by_pixel(0, -21),
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/hr-spidertron-legs-lower-end-B.png",
			width = 34,
			height = 92,
			variation_count = 8,
			scale = 0.5,
	...
	reflection_top_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-lower-end-A-water-reflection.png",
		width = 56,
		height = 110,
		variation_count = 1,
		scale = 0.5,
	...
	reflection_middle = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-lower-stretchable-water-reflection.png",
		width = 72,
		height = 384,
		variation_count = 1,
		scale = 0.25,
	...
	reflection_bottom_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-lower-end-B-water-reflection.png",
		width = 52,
		height = 104,
		variation_count = 1,
		scale = 0.5,
...
local leg_upper_part_graphics_definitions = {
	...
	top_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-upper-end-A.png",
		width = 22,
		height = 44,
		variation_count = 8,
		shift = util.by_pixel(0, 18),
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/hr-spidertron-legs-upper-end-A.png",
			width = 42,
			height = 86,
			variation_count = 8,
			scale = 0.5,
	...
	middle = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-upper-stretchable.png",
		width = 30,
		height = 128,
		variation_count = 8,
		scale = 0.5,
		...
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/hr-spidertron-legs-upper-stretchable.png",
			width = 60,
			height = 256,
			variation_count = 8,
			scale = 0.25,
	...
	bottom_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-upper-end-B.png",
		width = 20,
		height = 30,
		variation_count = 8,
		shift = util.by_pixel(1, -9),
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/hr-spidertron-legs-upper-end-B.png",
			width = 38,
			height = 58,
			variation_count = 8,
			scale = 0.5,
	...
	reflection_top_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-upper-end-A-water-reflection.png",
		width = 64,
		height = 96,
		variation_count = 1,
		scale = 0.5,
	...
	reflection_middle = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-upper-stretchable-water-reflection.png",
		width = 80,
		height = 256,
		variation_count = 1,
		scale = 0.25,
	...
	reflection_bottom_end = {
		direction_count = 1,
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-upper-end-B-water-reflection.png",
		width = 56,
		height = 74,
		variation_count = 1,
		scale = 0.5,
...
local leg_joint_graphics_definitions = {
	direction_count = 1,
	filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/spidertron-legs-knee.png",
	width = 12,
	height = 14,
	variation_count = 8,
	shift = util.by_pixel(1, 0),
	hr_version = {
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/legs/hr-spidertron-legs-knee.png",
		width = 22,
		height = 28,
		variation_count = 8,
		scale = 0.5,
...
local spidertron_torso_graphics_set = {
	base_animation = {
		layers = {
			{
				filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/spidertron-body-bottom.png",
				width = 64,
				height = 54,
				line_length = 1,
				direction_count = 1,
				...
				hr_version = {
					filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/hr-spidertron-body-bottom.png",
					width = 126,
					height = 106,
					line_length = 1,
					direction_count = 1,
			...
			{
				filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/spidertron-body-bottom-mask.png",
				width = 62,
				height = 46,
				line_length = 1,
				direction_count = 1,
				...
				hr_version = {
					filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/hr-spidertron-body-bottom-mask.png",
					width = 124,
					height = 90,
					line_length = 1,
					direction_count = 1,
	...
	shadow_base_animation = {
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/spidertron-body-bottom-shadow.png",
		width = 72,
		height = 48,
		line_length = 1,
		direction_count = 1,
		...
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/hr-spidertron-body-bottom-shadow.png",
			width = 144,
			height = 96,
			line_length = 1,
			direction_count = 1,
	...
	animation = {
		layers = {
			{
				filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/spidertron-body.png",
				width = 66,
				height = 70,
				line_length = 8,
				direction_count = 64,
				...
				hr_version = {
					filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/hr-spidertron-body.png",
					width = 132,
					height = 138,
					line_length = 8,
					direction_count = 64,
			...
			{
				filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/spidertron-body-mask.png",
				width = 66,
				height = 50,
				line_length = 8,
				direction_count = 64,
				...
				hr_version = {
					filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/hr-spidertron-body-mask.png",
					width = 130,
					height = 100,
					line_length = 8,
					direction_count = 64,
	...
	shadow_animation = {
		filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/spidertron-body-shadow.png",
		width = 96,
		height = 48,
		line_length = 8,
		direction_count = 64,
		...
		hr_version = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/hr-spidertron-body-shadow.png",
			width = 192,
			height = 94,
			line_length = 8,
			direction_count = 64,
	...
	water_reflection = {
		pictures = {
			filename = "__spidertrontiers-cu-fix__/graphics/entity/spidertron_mk2/torso/spidertron-body-water-reflection.png",
			width = 448,
			height = 448,
			variation_count = 1,
			scale = 0.5,
