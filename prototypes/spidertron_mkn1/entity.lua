...
local spidertron_mk_1_animations =
	require("__spidertrontiers-cu-fix__.spidertron_animations.spidertron_mkn1-animations")
local ground_triggers = require("__spidertrontiers-cu-fix__.prototypes.ground_triggers")
local simulation = require("__spidertrontiers-cu-fix__.prototypes.spidertron_mkn1.simulation")
